...
from emm.ops import init_emm, vllm_alloc_kv_cache
from emm.vmm_ops import map_to_kv_tensors, shutdown_emm
...
print("Initializing emm")
torch.cuda.set_device(0)
init_emm()
print("Initialized emm")

print("Creating KV tensors")
# ktensors = emm_ops.create_ktensors(
#     layer_mem_size, dtype, device, num_layers
# )
# vtensors = emm_ops.create_vtensors(
#     layer_mem_size, dtype, device, num_layers
# )
