...
def launch_endpoint(
    ...
    """
    Launch server endpoint for sending requests and receive responses.
    The server consists of an HTTP server and a redis client. They both run in the main process.
    """
...
class Engine:
    ...
    def generate(
        ...
        # TODO (): refactor to reduce the duplicated code
