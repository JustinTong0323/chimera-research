...
def flash_decode_sparse_attention_fwd(
    ...
    # NOTE: Apply sparse decoding when min > heavy_token_num and max > sparse decoding threshold
    # TODO: Change a faster topk implementation
