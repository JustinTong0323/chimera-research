...
class DoubleSparseAttnBackend(AttentionBackend):
    ...
    def init_cuda_graph_state(self, max_bs: int):
        # TODO: Support CUDA graph for double sparse attention
        raise ValueError(
    ...
    def forward_decode(
        ...
        # NOTE shouldn't be used when max_len_in_batch < heavy_token_num
        ...
        if (
            ...
            # TODO: indexing with torch.gather or torch.index_select or customized kernel
